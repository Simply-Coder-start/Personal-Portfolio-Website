        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Building intelligent, scalable AI-driven applications — from browser
                automation systems to conversational AI and predictive analytics solutions.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Analysing patterns and building predictive models using machine
                learning, NLP, and computer vision to extract meaningful insights.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
